...
module.exports.run = async (bot, message, args) => {
  ...
  if (!muterole) {
    ...
    const muteembed = new Discord.RichEmbed()
        ...
        message.reply(`${user} Have been muted for **${ms(ms(mutetime))}**. Now the chat will be silence 😆`).then(msg => msg.delete(10000));
        ...
        setTimeout(function(){
            ...
            message.reply(`${user} Have been unmuted! Now can you talk! 😭`).then(msg => msg.delete(10000));
